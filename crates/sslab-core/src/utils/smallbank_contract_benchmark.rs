use crate::execution_models::execution_storage::{self, SerialEVMStorage, ConcurrentEVMStorage};
...
pub fn default_memory_storage() -> SerialEVMStorage {
    execution_storage::memory_storage(
...
pub fn concurrent_evm_storage() -> ConcurrentEVMStorage {
    execution_storage::concurrent_evm_storage(
        DEFAULT_CONTRACT_ADDRESS, 
        CONTRACT_BYTECODE, 
        ADMIN_ADDRESS)
}